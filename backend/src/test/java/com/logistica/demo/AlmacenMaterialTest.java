...
public class AlmacenMaterialTest {

    private static final Logger log = LoggerFactory.getLogger(AlmacenMaterialTest.class);
    ...
    public void getAlmacenesTest() throws JSONException  {
        ResponseEntity<String> response = this.restTemplate
                .exchange("/almacenes",HttpMethod.GET,
                        ...
                        String.class);
        JSONArray json = new JSONArray("[{\"nombre\":\"X\",\"id\":1,\"niveles\":[]},{\"nombre\":\"Y\",\"id\":2,\"niveles\":[{\"nombre\":\"1\",\"id\":1,\"poses\":[{\"nombre\":\"A\",\"id\":1,\"ubicacion\":\"Y/1/A\"}]}]}]");
    ...
    public void postAlmacencesTest() throws JSONException {
        ...
        ResponseEntity<String> resultado = this.restTemplate
                .exchange("/almacenes",HttpMethod.GET,
                        new HttpEntity<>(null,headers),
                        String.class);
        JSONArray json = new JSONArray("[{\"nombre\":\"X\",\"id\":1,\"niveles\":[]},{\"nombre\":\"zonabonita\",\"id\":2,\"niveles\":[{\"nombre\":\"A\",\"id\":1,\"poses\":[{\"nombre\":\"A\",\"id\":1,\"ubicacion\":\"zonabonita/A/A\"}]}]}]");
